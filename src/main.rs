...
macro_rules! MS_TRUSTED_CLIENT_TOKEN {() => {"6A5AA1D4EAFF4E9FB37E23D68491D6F4"}}
const MS_LIST_URL: &'static str = concat!("https://speech.platform.bing.com/consumer/speech/synthesize/readaloud/voices/list?trustedclienttoken=", MS_TRUSTED_CLIENT_TOKEN!());
const MS_SPEECH_URL: &'static str = concat!("wss://speech.platform.bing.com/consumer/speech/synthesize/readaloud/edge/v1?TrustedClientToken=", MS_TRUSTED_CLIENT_TOKEN!());

const CONNECTION: &'static str = "wss://echo.websocket.org";

fn main() {
    println!("{}", MS_LIST_URL);
    println!("{}", MS_SPEECH_URL);
